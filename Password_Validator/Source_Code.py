...
def instructions():
    ...
    print("6: PASSWORD MUST CONSIST OF SPECIAL CHARACTER - !, @, #, $, %, ^, &, *, (, ), _, -, ~ ")
    print("7: PASSWORD SHOULD START WITH EITHER ANY SPECIAL CHARACTER OR WITH 2 DIGIT'S NUMBER")
    print("8: PASSWORD SHOULD MUST CONTAIN ATLEAST 3 UPPER-CASE CHARACTER AND 3 LOWER-CASE CHARACTER")
    print("9: PASSWORD SHOULD MUST CONTAIN ATLEAST 3 SPECIAL CHARACTER")
    print("10: PASSWORD SHOULD NOT CONTAIN 5 SAME CHARACTER OR NUMBER CONSECUTIVELY ")
    print("11: PASSWORD SHOULD NOT HAVE USERNAME INTO IT AT ANY POSITION")
    print("12: PASSWORD SHOULD NOT CONTAIN 3 SAME SPECIAL CHARACTER'S CONSECUTIVELY")
...
def password_validator_main(user_name, user_pass):
    ...
    if return_checklen is False:
        ...
        if return_checkupper is False:
            print("PASSWORD INVALID, THE PASSWORD SHOULD CONTAIN OF ATLEAST MINIMUM 3 UPPER-CASE CHARACTER [A-Z] ")
            user_newpass = get_password()
            password_validator_main(user_name, user_newpass)
        else:
            ...
            if return_checklower is False:
                print("PASSWORD INVALID, THE PASSWORD SHOULD CONTAIN OF ATLEAST 3 LOWER-CASE CHARACTER [a-z] ")
                user_newpass = get_password()
                password_validator_main(user_name, user_newpass)
            else:
                ...
                if return_checknumber is False:
                    print("PASSWORD INVALID, THE PASSWORD SHOULD CONSIST OF NUMBER [0-9]")
                    user_newpass = get_password()
                    password_validator_main(user_name, user_newpass)
                else:
                    ...
                    if return_checkspecial is False:
                        print("PASSWORD INVALID, PASSWORD SHOULD CONTAIN OF ATLEAST 3 SPECIAL CHARACTER - !, @, #, $, %, ^, &, *, (, ), _, -, ~ ")
                        user_newpass = get_password()
                        password_validator_main(user_name, user_newpass)
                    else:
                        print(" THE PASSWORD PASSED SPECIAL CHARACTER CONDITION !! ")
                        return_checkstart = check_start(user_pass)

                        if return_checkstart is False:
                            print("PASSWORD SHOULD START WITH EITHER ANY SPECIAL CHARACTER OR WITH 2 DIGIT'S NUMBER")
                            user_newpass = get_password()
                            password_validator_main(user_name, user_newpass)
                        else:
                            ...
                            if return_checkuser is False:
                                print("PASSWORD INVALID, PASSWORD SHOULD NOT HAVE USERNAME INTO IT AT ANY POSITION")
                                user_newpass = get_password()
                                password_validator_main(user_name, user_newpass)
                            else:
                                print(" PASSWORD PASSED AS IT DOES'NT INCLUDE USERNAME IN IT ")
                                return_checkconsi = check_consi(user_pass)

                                if return_checkconsi is False:
                                    print("PASSWORD INVALID, PASSWORD CONTAINS MORE THAN 5 SAME CHARACTER OR NUMBER CONSECUTIVELY ")
                                    user_newpass = get_password()
                                    password_validator_main(user_name, user_newpass)
                                else:
...
def check_length(user_pass):
    if len(user_pass)<12:
        print("INVALID PASSWORD, THE PASSWORD SHOULD CONTAIN MINIMUM 12 CHARACTER IN IT ! ")
        return False
    elif len(user_pass)>20:
        print("INVALID PASSWORD, THE PASSWORD SHOULD NOT CONTAIN MORE THAN 20 CHARACTER IN IT ! ")
        return False
    else:
        return True
...
# TO CHECK PASSWORD SHOULD START WITH EITHER ANY SPECIAL CHARACTER OR WITH 2 DIGIT'S NUMBER
